...
### Coeficiente de GINI
```{r, echo=FALSE, fig.height=7, fig.width=14}
sub_df <- df_original[,c("COUNTRY","GINI")]
...
mapParams <- mapCountryData(map, 
               nameColumnToPlot="GINI", 
               catMethod="fixedWidth", 
               mapTitle = "Coeficiente de GINI", 
               colourPalette = colourPalette,
               oceanCol='lightblue',
               missingCountryCol = 'white',
               borderCol = 'gray',
...
```{r, echo=FALSE, fig.height=7, fig.width=14}
sub_df <- df_original[,c("COUNTRY","PER_CAPTA_WD_M3_2010")]
...
mapParams <- mapCountryData(map, 
               nameColumnToPlot="PER_CAPTA_WD_M3_2010", 
               catMethod="fixedWidth", 
               mapTitle = "Consumo de agua doce per capta em m³", 
               colourPalette = "topo",
               oceanCol='lightblue',
               missingCountryCol = 'white',
               borderCol = 'gray',
...
```{r, echo=FALSE, fig.height=7, fig.width=14}
sub_df <- df_original[,c("COUNTRY","ACCESS_TO_IDRINKING_WATER_2008")]
...
mapParams <- mapCountryData(map, 
               nameColumnToPlot="ACCESS_TO_IDRINKING_WATER_2008", 
               catMethod="fixedWidth", 
               mapTitle = "Parcela da populacao com acesso ao consumo de agua potavel", 
               colourPalette = "topo",
               oceanCol='lightblue',
               missingCountryCol = 'white',
               borderCol = 'gray',
